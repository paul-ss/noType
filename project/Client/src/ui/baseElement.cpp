...
static std::string enumToStr(ElementName l_type) {
    switch (l_type) {
        ...
        case ElementName::TimeToStart:
            return "TimeToStart";
        case ElementName::ProgressBar1:
            return "ProgressBar1";
        case ElementName::ProgressBar2:
            return "ProgressBar2";
        case ElementName::ProgressBar3:
            return "ProgressBar3";
        case ElementName::ProgressBar4:
            return "ProgressBar4";
        case ElementName::ProgressBar5:
            return "ProgressBar5";
